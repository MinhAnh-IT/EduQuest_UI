...
enum StatusCode {
  ...
  static StatusCode fromCode(int code, {String? responseMessage}) {
    ...
    if (code == 200) {
      ...
      if (responseMessage == "Successfully joined class") return StatusCode.JOIN_CLASS_SUCCESS;
      if (responseMessage == "Successfully left class") return StatusCode.LEAVE_CLASS_SUCCESS;
