...
class SampleAssignments {
  /// Tạo danh sách assignments mẫu dựa trên classId và className
  static List<Assignment> createAssignmentsByClassName(int classId, String className) {
    ...
    return [
      Assignment(
        id: 1,
        classId: classId,
        name: 'Bài tập 1: $className - Cơ bản',
        startAt: baseDate.subtract(const Duration(days: 7)),
        endAt: baseDate.add(const Duration(days: 7)),
        durationMinutes: 60,
        status: 'submitted',
        questionCount: 10,
      ),
      Assignment(
        id: 2,
        classId: classId,
        name: 'Bài tập 2: $className - Nâng cao',
        startAt: baseDate.subtract(const Duration(days: 3)),
        endAt: baseDate.add(const Duration(days: 14)),
        durationMinutes: 90,
        status: 'pending',
        questionCount: 15,
      ),
      Assignment(
        id: 3,
        classId: classId,
        name: 'Bài tập 3: $className - Thực hành',
        startAt: baseDate.add(const Duration(days: 1)),
        endAt: baseDate.add(const Duration(days: 21)),
        durationMinutes: 120,
        status: null,
        questionCount: 20,
      ),
